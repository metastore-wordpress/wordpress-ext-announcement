...
/**
 * Class WP_EXT_Announcement_Template
 */
class WP_EXT_Announcement_Template extends WP_EXT_Announcement {
 ...
 *
 * @return WP_EXT_Announcement_Template
 */
function WP_EXT_Announcement_Template() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Announcement_Template;
	}
 ...
 */
add_action( 'plugins_loaded', [ WP_EXT_Announcement_Template(), 'run' ] );
