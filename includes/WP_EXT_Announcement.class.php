...
class WP_EXT_Announcement {
	...
	public function __construct() {
		...
		$this->archive_ID = 'announcements';
		$this->domain_ID  = 'announcement';
		$this->cap_type   = [ 'pt_announcement', 'pt_announcements' ];
 ...
 *
 * @return WP_EXT_Announcement
 */
function WP_EXT_Announcement() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Announcement;
	}
 ...
 */
add_action( 'plugins_loaded', [ WP_EXT_Announcement(), 'run' ] );
