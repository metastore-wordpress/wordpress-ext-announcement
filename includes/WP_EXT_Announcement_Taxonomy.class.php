...
/**
 * Class WP_EXT_Announcement_Taxonomy
 */
class WP_EXT_Announcement_Taxonomy extends WP_EXT_Announcement {
	...
	public function taxonomy_meta() {
		$labels  = [
			'name'                       => _x( 'Announcement Meta', 'Meta General Name', 'wp-ext-' . $this->domain_ID ),
 ...
 *
 * @return WP_EXT_Announcement_Taxonomy
 */
function WP_EXT_Announcement_Taxonomy() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Announcement_Taxonomy;
	}
 ...
 */
add_action( 'plugins_loaded', [ WP_EXT_Announcement_Taxonomy(), 'run' ] );
