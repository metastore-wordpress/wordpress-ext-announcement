...
/**
 * Class WP_EXT_Announcement_Post_Type
 * ------------------------------------------------------------------------------------------------------------------ */

class WP_EXT_Announcement_Post_Type extends WP_EXT_Announcement {
	...
	public function post_type() {
		$labels       = [
			'name'                  => _x( 'Объявления', 'Announcement General Name', 'wp-ext-' . $this->domain_ID ),
			'singular_name'         => _x( 'Объявление', 'Announcement Singular Name', 'wp-ext-' . $this->domain_ID ),
			'menu_name'             => __( 'Объявления', 'wp-ext-' . $this->domain_ID ),
			'name_admin_bar'        => __( 'Объявление', 'wp-ext-' . $this->domain_ID ),
		...
		$args         = [
			'label'               => __( 'Объявление', 'wp-ext-' . $this->domain_ID ),
			'description'         => __( 'Announcement Description', 'wp-ext-' . $this->domain_ID ),
			'labels'              => $labels,
 ...
 *
 * @return WP_EXT_Announcement_Post_Type
 * ------------------------------------------------------------------------------------------------------------------ */

function WP_EXT_Announcement_Post_Type() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Announcement_Post_Type;
	}
...
add_action( 'plugins_loaded', [ WP_EXT_Announcement_Post_Type(), 'run' ] );
